...
function t396_init(t) {
  ...
  if (o) {
    ...
    if (s) {
      ...
      u(),
        setInterval(u, 3e3),
        document.fonts && document.fonts.ready.then(u),
        o.querySelectorAll("img").forEach(function (t) {
          t.onload = u;
        }),
...
function t396__getWindowDimensions(t) {
  var e,
    ...
    n;
  return (
    (o || r) && t396__updateWindowDimensions(),
    {
...
function t396__onResize() {
  t396_waitForFinalEvent(
    function () {
      ...
      var i,
        o,
        r = e !== t396__getWindowDimensions().width;
...
function t396_doResize(t, e) {
  ...
  t396__setGlobalScaleVariables(t, n, s),
    t396_updateTNobj(t),
...
function t396__getAutoHeight(t) {
  var e,
    ...
    o = Array.from(t.querySelectorAll(":scope > .tn-group, :scope > .tn-elem")),
    r = o.some(function (t) {
      return "gallery" === t.getAttribute("data-elem-type");
    });
  if (i && !r) {
    var n = t.style.height;
    (t.style.height = "auto"), (e = t.offsetHeight), (t.style.height = n);
  } else
    e = o.reduce(function (e, i) {
...
function t396__autoHeight__getAdditionalOffsetForGallery(t) {
  var e = 0,
    ...
    o = "none" !== t396_core__getFieldValue(t, "slds_dotscontrols"),
    r = "under" === t396_core__getFieldValue(t, "slds_arrowcontrols");
  if (i || o || r) {
...
function t396_detectResolution(t) {
  ...
  var e,
    ...
    r;
  return (
    window.tn[o].screens.forEach(function (t) {
      i >= t && (r = t);
    }),
    void 0 === r && (r = window.tn[o].screens[0]),
    r
  );
}
...
function t396_updateTNobj(t) {
  for (
    var e,
      ...
      o = "ab" + t,
      r = window.tn[o].screens.slice().reverse(),
      n = 0;
    n < r.length;
    n++
  )
    window.tn[o].curResolution === r[n] &&
      ((window.tn[o].canvas_min_width = r[n]),
      (window.tn[o].canvas_max_width = 0 === n ? i : r[n - 1]));
  var a = "allrecords" === window.zero_window_width_hook;
  window.tn[o].grid_width = window.tn[o].canvas_min_width;
  var l = (i - window.tn[o].grid_width) / 2;
  window.tn[o].grid_offset_left = l < 0 && a ? 0 : l;
}
...
function t396_addShape(t, e) {
  ...
  if (i) {
    ...
    (o += "container,axisx,axisy,widthunits,heightunits,leftunits,topunits"),
      i.setAttribute("data-fields", o),
...
function t396__updateBackdropFilterOnImage(t) {
  if (t) {
    var e = t,
      ...
      r = "";
    o && ((e = o), (r = window.getComputedStyle(e).webkitBackdropFilter || "")),
...
function t396_elem__getFieldValue(t, e) {
  ...
  var o = i.closest(".t396__artboard"),
    ...
    a;
  void 0 === window.tn[n] &&
    (t396_initTNobj(r, o), t396_switchResolution(r, t396_detectResolution(r)));
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  ...
  var r = o.closest(".t396__artboard"),
    ...
    f = !u && d && c,
    w = !u && d && !c,
    g = t396_elem__getFieldValue(o, "axisy"),
    h = t396_elem__getFieldValue(o, "axisx"),
    p = t396_elem__getFieldValue(o, "container"),
    m =
      o.classList.contains("tn-group") &&
      "physical" === t396_group__getFieldValue(o, "type"),
  ...
  switch (e) {
    case "left":
      var z,
        ...
        L;
      if (
        ((F = "grid" === p ? "grid" : "window"),
        (A = "grid" === p ? window.tn[a].grid_offset_left : 0),
        (V = "grid" === p ? window.tn[a].grid_width : B),
        "%" === t396_elem__getFieldValue(o, "leftunits") &&
        ...
        "%" === t396_group__getFieldValue(b, "leftunits") &&
          (T = t396_roundFloat((V * T) / 100)),
          (y -= T);
        break;
      }
      !u && d ? "grid" === p && c && (y *= I) : (y = A + y),
        "center" === h &&
          ((S = t396_elem__getWidth(o)),
          f && "window" !== F && ((V *= I), (S *= I)),
          (y = V / 2 - S / 2 + y)),
        "right" === h &&
          ((S = t396_elem__getWidth(o)),
        ...
        f &&
          "window" !== F &&
          (y += ((S = t396_elem__getWidth(o)) * I - S) / 2);
      break;
    case "top":
      var q = o.closest(".t396__artboard"),
        R = q ? q.getAttribute("data-artboard-proxy-min-offset-top") : "0",
        W = q ? q.getAttribute("data-artboard-proxy-min-height") : "0",
        H = q ? q.getAttribute("data-artboard-proxy-max-height") : "0",
        M = function t(e) {
      ...
      if (
        ((F = "grid" === p ? "grid" : "window"),
        (x = "grid" === p ? parseFloat(R) : 0),
        (k = "grid" === p ? parseFloat(W) : parseFloat(H)),
        "%" === t396_elem__getFieldValue(o, "topunits") && (y = k * (y / 100)),
        v)
      ) {
        var P = parseInt(t396_group__getFieldValue(b, "top"), 10),
          N;
        "%" === t396_group__getFieldValue(b, "topunits") &&
          (P = t396_roundFloat((k * P) / 100)),
          (y -= P);
        break;
      }
      f && "window" !== F && (y *= I),
        w && "window" !== F && (x = "stretch" === l ? 0 : x / I),
        (y = x + y);
      var D = t396_ab__getFieldValue(q, "height_vh"),
        j = t396_ab__getFieldValue(q, "height"),
        G = t396_ab__getHeight(q),
        Z;
      if (
        ...
        "center" === g &&
          ...
          u ||
            ...
            "window" === F ||
            "stretch" !== l ||
            ((k = Z ? (Z > G ? Z : G) : q.clientHeight), (k /= I)),
          (y = k / 2 - E / 2 + y)),
        "bottom" === g &&
          ((E = M(o)),
          f &&
...
function t396_group__getFieldValue(t, e) {
  ...
  var i,
    o,
    r = "ab" + t.closest(".t396__artboard").getAttribute("data-artboard-recid"),
...
function t396_elem__getHeight(t, e) {
  ...
  if (
    ...
    (o = i.clientHeight
      ? i.clientHeight
      : t396_elem__getFieldValue(i, "height")),
      (o = parseFloat(o));
  }
  return o;
}
...
function t396__fixElementsFontSizes(t) {
  var e = !window.t396__isMobile && window.t396__isIPad;
  if (
    e ||
    window.t396__isFacebookMessengerInApp ||
    window.t396__isInstagramInApp
    ...
    i.read(function () {
      Array.prototype.forEach.call(t, function (t) {
        ...
        if ("text" === e || "button" === e) {
          ...
          if (i) {
            ...
            if (
              (r && r.style.zoom && (n.zoom = parseFloat(r.style.zoom)),
              1 !== n.zoom)
            ) {
              if ("text" === e) {
                var a = t.parentNode.closest(".tn-group") || t.parentNode,
                  l = a && t396__isFlex(a);
                (n.width = t.style.width),
                  (n.height = t.style.height),
                  (n.isParentGroupAutolayout = l);
              }
              o.push(n);
            }
          }
      ...
      i.write(function () {
        o.forEach(function (t) {
          e &&
            ("text" !== t.elementType ||
              t.isParentGroupAutolayout ||
              (t.width &&
                "auto" !== t.width &&
                (t.element.style.width =
                  "calc(" + t.width + " * var(--zoom, 1))"),
              t.height &&
                "auto" !== t.height &&
                (t.element.style.height =
                  "calc(" + t.height + " * var(--zoom, 1))"))),
...
function t396__initializeArtboardOverflow(t, e) {
  if (e && t) {
    ...
    if ("auto" === i) {
      var o = t.getAttribute("data-tilda-lazy");
      ("y" !== window.lazy && "yes" !== o) ||
